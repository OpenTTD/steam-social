...
app_filename=(_CPack_Packages/*/Bundle/steam-social-*/OpenTTD-steam-social.app)

if [ "${app_filename}" = "_CPack_Packages/*/Bundle/steam-social-*/OpenTTD-steam-social.app" ]; then
